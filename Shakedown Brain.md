...
Shakedown is a verification harness for new Macs. A procedure for catching batch-level defects in the return window. (Name borrowed from engineering, where a *shakedown run* is the first-run stress test of new machinery before commissioning.)
